  ...
  return (
    <aside className="bg-white flex flex-col items-center py-6 px-2.5 gap-2 shadow-[8px_0px_25px_0px_rgba(226,232,240,0.75)] shrink-0 h-full">
      ...
      <button
        ...
        className="flex flex-col items-center justify-center w-12 h-12 rounded-2xl text-[#94a3b8] hover:bg-red-50 hover:text-red-500 transition-all group relative cursor-pointer"
      >
